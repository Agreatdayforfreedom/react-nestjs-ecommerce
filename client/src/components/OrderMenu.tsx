  ...
  return (
    <div className="md:relative flex justify-end my-1 mx-3">
      <div className="mx-2 p-1 px-8 bg-slate-900 font-bold text-white">
        ...
        <ul
          className={`${
            hidden.orderby ? 'block transition-all' : 'hidden w-0 h-0 transition-all'
        ...
        >
          ...
          <li
            ...
            onClick={() => {
              ...
              setParams({ order: Order.priceDESC });
          ...
          <li
            ...
            onClick={() => {
              ...
              setParams({ order: Order.priceASC });
